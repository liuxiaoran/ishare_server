...
class Delete_Comment_C extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $param_names = array('id', 'card_id', 'rating');
        $param_need_names = array('open_id', 'key', 'page_num', 'id', 'card_id', 'rating');
        ...
        if ($message != null) {
            ...
            if (!$this->User_m->verify_session_key($_POST)) {
                ...
                if ($this->Comment_m->delete($params['id'], $params['card_id'], $params['rating'])) {

...
class Get_Near_Request_Card_C extends CI_Controller {
    ...
    public function index() {
        ...
        $para_name_array = array('user_longitude', 'user_latitude', 'page_num', 'page_size', 'kilometer');
        ...
        if ($error_message == null) {
            ...
            $response['data'] = $this->Request_card_m->get_near($paras['user_longitude'],$paras['user_latitude'],$paras['page_num'],$paras['page_size']);

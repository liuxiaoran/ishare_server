...
class Get_Request_Card_C extends CI_Controller
{
    ...
    public function index() {
        ...
        $param_names = array('user_longitude', 'user_latitude', 'page_num', 'page_size');
        $param_need_names = array('open_id', 'key', 'user_longitude', 'user_latitude', 'page_num', 'page_size');
        ...
        if ($message != null) {
            ...
            if (!$this->User_m->verify_session_key($_POST)) {
                ...
                $data = $this->Request_card_m->get($params['user_longitude'], $params['user_latitude'], $params['page_num'], $params['page_size']);

...
class Update_Request_Card_C extends CI_Controller
{
    ...
    public function index() {
        ...
        $param_names = array('id', 'shop_name', 'shop_location', 'shop_longitude', 'shop_latitude', 'discount', 'ware_type', 'trade_type', 'description', 'user_longitude', 'user_latitude');
        ...
        if ($message != null) {
            ...
            if (!$this->User_m->verify_session_key($_POST)) {
                ...
                if ($this->Request_card_m->update($params, $params['id'])) {
